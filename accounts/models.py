...
class Department(AbstractUser):
    ...
    dept_name = models.CharField(
        _("Department Name"), default="dept_name", max_length=50, null=True, blank=True
    )
    ...
    president_signature_url = models.CharField(
        _("Link to President Signature"), max_length=200, null=True, blank=True
    )
    secretary_signature_url = models.CharField(
        _("Link to Financial Secretary Signature"),
        max_length=200,
        null=True,
        blank=True,
    )
